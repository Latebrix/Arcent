...
internal abstract class LocalUserRoomDb : RoomDatabase() {
    ...
    companion object {
        ...
        fun get(context: Context): LocalUserRoomDb = inst ?: synchronized(this) {
...
private object RoomFieldCrypto {
    ...
    fun enc(context: Context, plain: String): String {
    ...
    fun dec(context: Context, enc: String): String? = runCatching {
...
internal object LocalUserStore {
    suspend fun saveLocalUserName(context: Context, name: String) {
